...
def LaserScanProcess(data):
    ...
    min_angle, max_angle = largest_gap[0]*((data.angle_increment)*180/PI), largest_gap[-2]*((data.angle_increment)*180/PI)
...
def main():
    ...
    pub = rospy.Publisher('/cmd_vel_1', Twist, queue_size=10)
    rospy.Subscriber("/scan_1", sensor_msgs.msg.LaserScan , LaserScanProcess)

...
from math import *
def OdomCallback(message,cargs):
...
# Main Script
# Initialize our node
rospy.init_node('diff_control',anonymous=True)
     
# Set waypoint for Husky to drive to
goal = [3,0]  # Goal position in x/y
# Setup publisher
...
rospy.Subscriber('/odom',nav_msgs.msg.Odometry,OdomCallback,(cmdpub,cmdmsg,goal))
